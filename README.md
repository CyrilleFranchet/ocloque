...
Single-page app: **local time** on the left, **one or more IANA time zones** on the right, with a **+** button to add clocks. Served as static files behind **nginx** in Docker.
